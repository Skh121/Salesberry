...
public class SignUpForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/groupc/saleberry/image/shopping-cart_337208 (3).png"))); // NOI18N
    ...
    private void signUpMouseClicked(java.awt.event.MouseEvent evt) {                                    
        ...
        char[] pwd2=confirm_password.getPassword();
        String password2=new String(pwd2);
        if (first_name1.equals("") || last_name1.equals("") || contact_no1.equals("") || userId1.equals("") || pwd1.equals("") || pwd2.equals("")){
            JOptionPane.showMessageDialog(rootPane,"All field is required");
        }
        else{
        RegisterModel rm=new RegisterModel(userId1,contact_no1,first_name1,last_name1,password1,password2);
    ...
    private void contact_noActionPerformed(java.awt.event.ActionEvent evt) {                                           
        // TODO add your handling code here:
    }                                          
